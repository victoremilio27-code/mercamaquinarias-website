...
**Plans**: 4 plans
- [ ] 09-01-PLAN.md — Tabla de contactos verificados, código por número y SMS apagado tras el interruptor
- [ ] 09-02-PLAN.md — Rutas de verificación y filtro público de la ficha; la semilla sale verificada
- [ ] 09-03-PLAN.md — El vendedor verifica sus números desde el panel y desde el paso 4 de publicar
