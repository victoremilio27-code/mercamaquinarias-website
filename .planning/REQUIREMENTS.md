...
| UI-01 | Phase 2 — Tema claro y oscuro coherentes | En curso — 02-04 hecho 2026-09-25 | El ámbar ya no se queda congelado: sus 64 usos de texto pasaron a `--ambar-texto`, que sí se redefine en los dos bloques. Quedan los 216 hallazgos de `dinamismo`, que son literales y los convierte el `02-05` |
